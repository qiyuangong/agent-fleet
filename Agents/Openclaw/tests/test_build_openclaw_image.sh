...
mkdir -p "$PROJECT_DIR/scripts" \
         ...
         "$TMP_DIR/sii-opik-plugin/harness/openclaw" \
         "$TMP_DIR/sii-opik-plugin/src/sii_opik_plugin/openclaw" \
         "$TMP_DIR/bin"
touch "$TMP_DIR/sii-opik-plugin/src/sii_opik_plugin/openclaw/openclaw_opik_tracer.py"
touch "$TMP_DIR/sii-opik-plugin/requirements.txt"
printf '{"scripts":{"build":"true"}}\n' > "$TMP_DIR/sii-opik-plugin/harness/openclaw/package.json"
...
LOG="$LOG" \
OPIK_PLUGIN=enabled \
OPIK_PLUGIN_WORKSPACE="$TMP_DIR/sii-opik-plugin" \
