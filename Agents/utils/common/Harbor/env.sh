...
TB_NPM_CONFIG_REGISTRY="${TB_NPM_CONFIG_REGISTRY:-${NPM_CONFIG_REGISTRY:-}}"
TB_GO111MODULE="${TB_GO111MODULE:-${GO111MODULE:-on}}"
TB_GOPROXY="${TB_GOPROXY:-${GOPROXY:-https://goproxy.cn,direct}}"
TB_GOSUMDB="${TB_GOSUMDB:-${GOSUMDB:-sum.golang.google.cn}}"
TB_RUSTUP_UPDATE_ROOT="${TB_RUSTUP_UPDATE_ROOT:-${RUSTUP_UPDATE_ROOT:-https://mirrors.tuna.tsinghua.edu.cn/rustup/rustup}}"
TB_RUSTUP_DIST_SERVER="${TB_RUSTUP_DIST_SERVER:-${RUSTUP_DIST_SERVER:-https://mirrors.tuna.tsinghua.edu.cn/rustup}}"
TB_CARGO_REGISTRY_REPLACE_WITH="${TB_CARGO_REGISTRY_REPLACE_WITH:-${CARGO_REGISTRY_REPLACE_WITH:-mirror}}"
TB_CARGO_REGISTRY_URL="${TB_CARGO_REGISTRY_URL:-${CARGO_REGISTRY_URL:-sparse+https://mirrors.tuna.tsinghua.edu.cn/crates.io-index/}}"
...
export TB_CC_PY_WHEEL_DIR_SOURCE TB_CC_PY_WHEEL_DIR_MOUNT_PATH TB_CC_NPM_CACHE_MOUNT_PATH TB_VERIFIER_UV_HOME TB_VERIFIER_UV_BIN_DIR_MOUNT_PATH TB_TRACE_TO_OPIK TB_CC_OPIK_DEBUG TB_CC_OPIK_INSTALL_DEPS TB_NPM_CONFIG_REGISTRY
export TB_GO111MODULE TB_GOPROXY TB_GOSUMDB
export TB_RUSTUP_UPDATE_ROOT TB_RUSTUP_DIST_SERVER TB_CARGO_REGISTRY_REPLACE_WITH TB_CARGO_REGISTRY_URL
