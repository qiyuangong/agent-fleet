...
BASE_URL="${BASE_URL:-${ANTHROPIC_BASE_URL:-https://model.example.com}}"
TRACE_TO_OPIK="${TRACE_TO_OPIK:-true}"
OPIK_URL="${OPIK_URL:-https://opik.example.com:443/api}"
...
TB_PIP_INDEX_URL="${TB_PIP_INDEX_URL:-http://packages.example.com/repository/pypi/simple/}"
TB_PIP_EXTRA_INDEX_URL="${TB_PIP_EXTRA_INDEX_URL:-}"
TB_PIP_TRUSTED_HOST="${TB_PIP_TRUSTED_HOST:-packages.example.com}"
...
export HARBOR_ONLINE_ANALYSIS HARBOR_ONLINE_ANALYSIS_POLL_INTERVAL HARBOR_ONLINE_ANALYSIS_DIR HARBOR_ONLINE_ANALYSIS_PID_FILE HARBOR_ONLINE_ANALYSIS_LOG_FILE
